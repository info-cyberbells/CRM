...
import { getSingleCaseById, getTechUserAssignedCases } from "../../features/TechUserSlice/TechUserSlice";
...
const {cases,  pagination, isLoading, selectedCase, modalLoading} = useSelector((state)=> state.techUser);
        ...
        <form className="grid grid-cols-1 overflow-y-auto md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(updateSelectedCase({ customerName: e.target.value }))
              }
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(updateSelectedCase({ email: e.target.value }))
              }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(updateSelectedCase({ phone: e.target.value }))
              }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                dispatch(updateSelectedCase({ plan: e.target.value }))
              }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              // onChange={(e) =>
              //   dispatch(updateSelectedCase({ saleAmount: e.target.value }))
              // }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                dispatch(updateSelectedCase({ issue: e.target.value }))
              }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={(e) =>
                dispatch(
                  updateSelectedCase({ specialNotes: e.target.value })
                )
              }
              className="w-full px-3 py-2 border rounded-md text-sm"
            />
